...
int main()
{
    ...
    {
        cout << "============================================================================" << endl;
        cout << "=============== SCHOOL STAFF MANAGEMENT SYSTEM - UNIVERSITY ================" << endl;
        cout << "============================================================================" << endl;
        ...
        case 2:
        {
            ...
            string sID = "";
            std::getline(cin, sID);
            university.removeStaff(sID);
            break;
        }
        case 3:
        {
            university.updateSalary();
            break;
        }
        case 4:
        {
            cout << "Total salary: " << university.calcTotalSalary() << endl;
            break;
        }
        case 5:
        {
            if (university.getStaffList().empty())
            {
                cerr << "Staff list is empty." << endl;
                continue;
            }
            university.printHighestSalary();
            break;
        }
        ...
        case 6:
        {
            ...
            {
            case 1:
                university.printAllStaff();
                break;
            case 2:
                university.printAllLecturers();
                break;
            case 3:
                university.printAllTeachingAssistants();
                break;
            case 4:
                university.printAllResearchers();
                break;
            case 5:
                university.printAllSpecialists();
                break;
            case 6:
                university.printAllInterns();
                break;
            }
            break;
        }
